...
# 0) Paths & parameters
# ============================
CSV_META = Path("data/processed/all_people_7_20_2025.csv")       # ADNI Data Collections: Subject, Age, Sex, Acq Date ...
CSV_PRED = Path("data/processed/autorater_predictions_all4.csv") # Autorater results: subject_id, Acq_Date, autorater_prediction, H, label ...
OUT_DIR  = Path("figures/age_analysis")
